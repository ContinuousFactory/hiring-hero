defmodule Coherence.RegistrationController do
  ...
  * delete - delete the user account
  ...
  def create(conn, %{"registration" => registration_params} = params) do
    ...
    case Config.repo.insert(cs) do
      {:ok, user} ->
        ...
        |> create_organisation(user, registration_params["company_name"])
  ...
  defp create_organisation(conn, user, company_name) do
    changeset = Organisation.changeset(%Organisation{}, %{name: company_name, owner_id: user.id})
